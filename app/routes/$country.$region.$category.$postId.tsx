...
import { PostContent } from '~/components/posts/contents/post-content'
import { CommentForm } from '~/components/posts/contents/comment-form'
import { CommentList } from '~/components/posts/contents/comment-list'
