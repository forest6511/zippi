...
export function PostListItemWithThumbnail({ post, country, region, category }: PostListItemWithThumbnailProps) {
  return (
    <div className="bg-white p-4 border-t border-b flex">
      ...
      <div className="flex-grow">
        <Link to={`/${country}/${region}/${category}/${post.id}`} className="block hover:text-primary">
